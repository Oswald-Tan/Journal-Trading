...
// Pindahkan komponen MilestoneCard ke luar fungsi utama
...
const Targets = ({ onShowTargetModal = () => {} }) => {
  ...
  const handleSetTarget = () => {
    ...
    if (
      ...
      Swal.fire({
        ...
        text: "Please set your balance first before creating trading targets.",
        icon: "warning",
  ...
  // Performance metrics cards konsisten dengan dashboard
  const performanceMetrics = [
    {
      label: "Current Balance",
      value: formatCompactCurrency(currentBalance, currency),
